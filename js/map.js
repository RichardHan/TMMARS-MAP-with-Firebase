(function () {
    ...
    var update = function (sName) {
        // firebase can not handler large arrary. https://njdc.rest.mars.trendmicro.com/akamailog/base?random=0.5077556474134326 , call api directly.
        if (sName === "dots") {
            ...
            var url = fireBaseDataSrouce[sName];
            console.log(url);
